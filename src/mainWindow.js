...
import { loadBin } from "@nerimity/uiohook-napi";

import { uIOhook, UiohookKey } from "@nerimity/uiohook-napi";
...
const addonPath = join(process.resourcesPath, "nerimity-ptt-windows-x64.node");
loadBin(addonPath);
